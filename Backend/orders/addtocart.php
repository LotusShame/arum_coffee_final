          ...
          if (!empty($_SESSION['admin_gcCart'])){   
            $count_cart = count($_SESSION['admin_gcCart']); 
              for ($i=0; $i < $count_cart  ; $i++) { 
                ...
                //             <td> Rp.  <span id="sum" class="stot">'. $subtotal.'</span></td>
                //             <td>
                //           </tr>
                //           </tfoot>';
            ...
            <?php 
             ...
             ?>
              ...
              <div class="row" >
                ...
                <div class="col-xs-2">
                   <button  style="height: 30px;text-align:  center; font-size: 12px"  type="submit" id="submit" name="submit" class="text-center btn btn-primary  btn-xs">Lanjutkan Pemesanan</button> 
                </div>
              </div>
             </div> 
          <div class="clear"></div>
