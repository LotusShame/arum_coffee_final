    					...
    					$total = 0;
    						if (isset($_GET['orderno'])) {
								...
								foreach ($cur as $result) { 
						  		...
						  		echo '<td style="font-size:15px;">Rp. <input type="hidden" id="'.$result->ORDERID.'orderprice" value="'.$result->PRICE.'" >'.$result->PRICE.'</td>';
    			...
    			<table class="table table-bordered">
    				<thead>
    					<tr>
    						...
    						<th><input class="form-control" type="text" id="totamnt"  readonly="true" value="<?php echo number_format($total,0,'.',''); ?>">
                        ...
                        <tr>
                            ...
                            <th><input class="form-control" type="text" id="overalltot"  readonly="true" value="<?php echo number_format($total,0,'.',''); ?>">
